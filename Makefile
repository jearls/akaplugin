...
GLIB_INCLUDES = -I$(PIDGIN_DEV_ROOT)/win32-dev/gtk_2_0-2.14/include -I$(PIDGIN_DEV_ROOT)/win32-dev/gtk_2_0-2.14/include/glib-2.0 -I$(PIDGIN_DEV_ROOT)/win32-dev/gtk_2_0-2.14/lib/glib-2.0/include 
...
GLIB_LIBS = -L$(PIDGIN_DEV_ROOT)/win32-dev/gtk_2_0-2.14/lib -lglib-2.0 -lgobject-2.0 -lgmodule-2.0
